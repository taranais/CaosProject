...
namespace C2eUtils.ImageFormats
{
    ...
    internal class s16DecoderCore
    {
        ...
        ///
        /// </summary>
        /// <param name="Color565"></param>
        private float[] Get565Pixel(UInt16 Color565)
        {
            float[] pixel = new float[4];
            pixel[0]   = (( Color565 & 0xF800 ) >> 8 )  / 255f ;
            pixel[1]   = (( Color565 & 0x07E0 ) >> 3 )  / 255f ;
            pixel[2]   = (( Color565 & 0x001F ) << 3 )  / 255f ;
            if(pixel[0] == 0f && pixel[1] ==0f && pixel[2] == 0f)
            {
                pixel[3] = 1;
            }
            else{
